    ...
    <div className="min-h-[70vh] flex items-center justify-center bg-page px-4">
      <div className="max-w-xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/portfolio" className="inline-block rounded-full border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-800 hover:bg-page transition">
            View Portfolio
          </Link>
          <Link href="/contact" className="inline-block rounded-full border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-800 hover:bg-page transition">
            Contact Me
          </Link>
        </div>
      </div>
