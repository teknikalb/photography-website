...
export default function HolidayMiniSessionsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-2xl">
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Local studios with floral and spring decor</li>
        <li>Outdoor parks and gardens in Newington, Wethersfield, Glastonbury, West Hartford, Rocky Hill, Southington, and across Connecticut</li>
