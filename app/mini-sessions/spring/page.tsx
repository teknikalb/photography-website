...
export default function SpringMiniSessionsPage() {
  return (
    <div className="container mx-auto section-x py-16 max-w-2xl">
      ...
      <p className="mb-4 text-lg text-gray-700 text-center">Celebrate the season of renewal with vibrant spring mini sessions. Perfect for families, maternity, and portraits among blooming flowers and fresh greenery—limited spots available.</p>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>Outdoor locations with spring blooms</li>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Botanical gardens and parks throughout Connecticut</li>
        <li>Local gardens with spring blooms</li>
        <li>Wooded trails and open meadows across the state</li>
      </ul>
