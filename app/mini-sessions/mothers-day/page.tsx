...
export default function MothersDayMiniSessionsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-2xl">
      ...
      <p className="mb-4 text-lg text-gray-700 text-center">Honor the special bond between mother and child with a quick, heartfelt Mother's Day mini session. Capture cuddles, laughter, and love in a beautiful Connecticut setting. Reserve your spot in Newington, Wethersfield, Glastonbury, West Hartford, Rocky Hill, Southington, or across Connecticut!</p>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Elizabeth Park (Hartford), local gardens in Glastonbury & Wethersfield</li>
        <li>Parks and in-home sessions in Newington, Rocky Hill, Southington, and across Connecticut</li>
      </ul>
