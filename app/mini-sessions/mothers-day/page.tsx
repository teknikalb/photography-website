...
export default function MothersDayMiniSessionsPage() {
  return (
    <div className="container mx-auto section-x py-16 max-w-2xl">
      ...
      <p className="mb-4 text-lg text-gray-700 text-center">Honor the special bond between mother and child with a quick, heartfelt Mother's Day mini session. Capture cuddles, laughter, and love in a beautiful Connecticut setting—limited spots available.</p>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Botanical gardens and parks with spring blooms</li>
        <li>In-home sessions for an intimate feel</li>
        <li>Local gardens and outdoor spaces across Connecticut</li>
      </ul>
