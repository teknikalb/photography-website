...
export default function SummerMiniSessionsPage() {
  return (
    <div className="container mx-auto section-x py-16 max-w-2xl">
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Hammonasset Beach, Madison; Greenwich & Darien coastal spots</li>
        <li>Elizabeth Park (Hartford), West Hartford Reservoir, Glastonbury</li>
        <li>Local parks in Rocky Hill, Southington, and across Connecticut</li>
      </ul>
