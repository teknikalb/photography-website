...
export default function SummerMiniSessionsPage() {
  return (
    <div className="container mx-auto section-x py-16 max-w-2xl">
      ...
      <p className="mb-4 text-lg text-gray-700 text-center">Enjoy the golden light and warm evenings with summer mini sessions. Perfect for families, couples, and milestone moments at your favorite park or beach—wherever you are in Connecticut.</p>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>Coastal spots along the Connecticut shoreline</li>
        <li>Parks and gardens in central Connecticut</li>
        <li>Local beaches, trails, and outdoor spaces across the state</li>
      </ul>
