...
import { Check, Camera, Award, Sparkles, Clock, Heart } from "lucide-react"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl font-light text-gray-700 max-w-3xl mx-auto">
              Professional portraits that capture your authentic self and tell your unique story.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Portrait sessions are about celebrating who you are and telling your story through beautiful, 
                authentic imagery. Whether for professional branding, graduation, or personal keepsakes.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="max-w-md mx-auto">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 mt-2">Portrait Session</p>
                </div>
